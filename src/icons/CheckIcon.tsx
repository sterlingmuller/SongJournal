...
const CheckIcon = ({ size = 24, isPrimaryText = false }: Props) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 22 22" fill="none">
      <Path
        ...
        stroke={isPrimaryText ? theme.primaryText : theme.secondaryText}
        fill={isPrimaryText ? theme.primaryText : theme.secondaryText}
        strokeWidth="1"
        strokeLinecap="round"
      />
    </Svg>
