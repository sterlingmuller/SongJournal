    ...
    >
      <View style={styles.container}>
        ...
        >
          ...
          {Platform.OS === 'ios' && (
            <BulletPoint>
              Long-pressing the text will bring up a magnifier, you can then
              drag to place your cursor exactly where you want.
            </BulletPoint>
          )}
          ...
          {Platform.OS === 'android' && (
            <BulletPoint>
              Shake your phone to revert your lyrics sheet to its last save
            </BulletPoint>
          )}
