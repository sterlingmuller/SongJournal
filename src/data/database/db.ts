...
const createPurchasesTable = `CREATE TABLE IF NOT EXISTS Purchases (id INTEGER PRIMARY KEY CHECK (id = 1), hasBadEgg BOOLEAN NOT NULL DEFAULT 1, hasCacsus BOOLEAN NOT NULL DEFAULT 1, hasDeadAdim BOOLEAN NOT NULL DEFAULT 1, hasPro BOOLEAN NOT NULL DEFAULT 0);
