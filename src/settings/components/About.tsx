...
const About = ({}) => {
   ...
   return (
    <View>
      ...
      <View>
      <Text style={settingsStyle.about}>This app was made by Sterling Muller. I don’t what a Terms of Service is so we’re probably fine. I hope you get a lot of good use out of my app, make killer songs, and spread the word to friends.</Text>
